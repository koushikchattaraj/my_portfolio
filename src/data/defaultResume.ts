...
export const defaultResume: ResumeData = {
  ...
  skills: [
    { label: 'Frontend', value: 'React.js, JavaScript (ES6+), TypeScript, HTML5, CSS3/SASS, Next.js' },
    { label: 'State Mgmt', value: 'Redux, Redux Toolkit, Redux Saga, Context API' },
    {
      label: 'UI & Styling',
      value: 'Responsive Design, Material UI, Styled Components, Tailwind CSS, WCAG Accessibility',
    },
    {
      label: 'Performance',
      value: 'Code Splitting, Lazy Loading, React.memo, useMemo, useCallback, Virtualization',
    },
    {
      label: 'Testing',
    ...
    {
      label: 'DevOps',
      value: 'Git, GitHub Actions, CI/CD, AWS (S3, CloudFront), Webpack, Vite, Cursor AI, Claude',
    },
    {
      label: 'Architecture',
      value: 'Micro Frontend (Module Federation), Component-Driven Design, REST API Integration',
    },
  ],
  experience: [
    {
  ...
  education: [
    ...
    { left: 'Bachelor of Technology in Computer Science and Engineering', right: 'CGPA: 7.32/10' },
  ],
  certifications: [
